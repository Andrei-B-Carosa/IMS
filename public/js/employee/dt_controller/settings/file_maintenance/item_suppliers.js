...
export var dtItemSuppliers = function (table,param=false) {
    ...
    function initTable(){
        ...
        $(`#${table}_table`).ready(function() {
            ...
            $(`#${table}_table`).on('click','.view-details',function(e){
                ...
                let modal_id = '#modal-add-item-suppliers';
                let form = $('#form-add-item-suppliers');

                let formData = new FormData;

                formData.append('id',id);
                _request.post('/file-maintenance/item-suppliers/info',formData)
                .then((res) => {
            ...
            $(`#${table}_table`).on('click','.delete',function(e){
                ...
                Alert.confirm('question','Remove this item supplier ?',{
                    onConfirm: function() {
