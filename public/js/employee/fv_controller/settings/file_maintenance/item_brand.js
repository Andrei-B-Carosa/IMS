...
export function fvItemBrand(_table=false,form_id){

    var init_fvItemBrand = (function () {

        var _handlefvItemBrand = function(){
            let fvItemBrand;
            ...
            if (!form.hasAttribute('data-fv-initialized')) {
                ...
                fvItemBrand = FormValidation.formValidation(form, {
            ...
            $(modal_id).on('click','.submit',function(e){
                ...
                fvItemBrand && fvItemBrand.validate().then(function (v) {
                    if(v == "Valid"){
