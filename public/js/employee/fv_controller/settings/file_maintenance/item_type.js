...
export function fvItemType(_table=false,form_id){

    var init_fvItemType = (function () {

        var _handlefvItemType = function(){
            let fvItemType;
            ...
            if (!form.hasAttribute('data-fv-initialized')) {
                ...
                fvItemType = FormValidation.formValidation(form, {
            ...
            $(modal_id).on('click','.cancel',function(e){
                ...
                Alert.confirm('question',"Close this form ?",{
                    onConfirm: () => {
                        ...
                        fvItemType.resetForm();
                        form.reset();
                        $(modal_id).find('select[name="is_active"]').val('').trigger('change');
                        $(modal_id).find('select[name="display_to"]').val('').trigger('change');
            ...
            $(modal_id).on('click','.submit',function(e){
                ...
                fvItemType && fvItemType.validate().then(function (v) {
                    if(v == "Valid"){
