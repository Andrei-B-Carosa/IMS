<div id="kt_app_content_container" class="app-container  container-fluid page-employee-registration">
    <div class="stepper stepper-pills stepper-column d-flex flex-column flex-xl-row flex-row-fluid gap-10 between"
        ...
        <div class="card d-flex justify-content-center justify-content-xl-start flex-row-auto w-100 w-xl-300px w-xxl-400px border border-gray-300 border-dashed">
            <div class="card-body px-6 px-lg-10 px-xxl-15 py-20">
                ...
                <div class="stepper-nav">
                    ...
                    {{-- <div class="stepper-item current" data-kt-stepper-element="nav">
                        ...
                        <div class="stepper-wrapper">
                            ...
                            <div class="stepper-icon w-40px h-40px">
                                <span class="svg-icon svg-icon-muted svg-icon-2hx stepper-check"><svg width="24"
                    ...
                    <!--begin::Step 4-->
                    <div class="stepper-item mark-complete pending" data-kt-stepper-element="nav">
                        <!--begin::Wrapper-->
                        <div class="stepper-wrapper">
                            <!--begin::Icon-->
                            <div class="stepper-icon w-40px h-40px">
        ...
        <!--begin::Content-->
        <div class="card d-flex flex-row-fluid flex-center border border-gray-300 border-dashed" id="kt_block_ui_1_target">
            <!--begin::Form-->
            <div class="card-body py-20 w-100 mw-xl-700px px-9 fv-plugins-bootstrap5 fv-plugins-framework">
                ...
                <div data-kt-stepper-element="content" class="current">
                    <div class="w-100">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container fv-plugins-bootstrap5-row-valid form1">
                        </div>
                    </div>
                </div>
                <!--end::Step 2-->
                ...
                <div data-kt-stepper-element="content" class="pending">
                    <div class="w-100">
                        <div class="pb-10 pb-lg-15">
                            <h2 class="fw-bold text-gray-900">Employment Info</h2>
                            <div class="text-muted fw-semibold fs-6">
                                If you need more info, please check out
                                <a href="#" class="link-primary fw-bold">Help Page</a>.
                            </div>
                    ...
                    <div class="w-100">
                        ...
                        <div class="mb-0">
                            ...
                            <div
                                ...
                                <!--begin::Icon-->
                                <span class="svg-icon svg-icon-muted svg-icon-2hx text-success me-4 mb-5 mb-sm-0"><svg
                ...
                <div class="d-flex flex-stack pt-10">
                    <!--begin::Wrapper-->
                    <div class="mr-2">
                        <button type="button" class="btn btn-lg btn-light-primary me-3 d-none"
                            data-kt-stepper-action="previous">
                            <span class="svg-icon svg-icon-muted svg-icon-2x me-2 ms-0"><svg width="24"
                                    height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                        <button type="button" class="btn btn-lg btn-primary me-3 d-none" data-kt-stepper-action="submit">
                            <span class="indicator-label">
                                Submit
                                <span class="svg-icon svg-icon-muted svg-icon-2x ms-2 me-0"><svg width="24"
                                        height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
