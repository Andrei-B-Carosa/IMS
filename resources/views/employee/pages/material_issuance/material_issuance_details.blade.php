<div class="page-material-issuance-details">

    <div class="card mb-10 card-material-issuance-details" id="">
        <div class="card-header cursor-pointer">
            <div class="card-title m-0">
                <h3 class="fw-bold m-0">Material Issuance No. {{ $data->form_no ??' ' }}</h3>
            </div>

            @if($data->status !=1)
                <button class="btn btn-primary align-self-center edit-material-issuance-details" data-id="{{ Crypt::encrypt($data->id) }}">
                    Edit Details
                </button>
            @endif
        </div>
        <div class="card-body p-9">
            ...
            <div class="row mb-7">
                <label class="col-lg-4 fw-semibold text-muted">MRS No: </label>
                <div class="col-lg-8">
                    <span class="fw-bold fs-6 text-gray-800">{{ $data->mrs_no }}</span>
                </div>
            </div>
            <div class="row mb-7">
            ...
            <div class="row mb-7">
                ...
                <div class="col-lg-8 d-flex align-items-center">
                    <span class="badge badge-{{ $data->status==1?'success':'info' }}">{{ $data->status==1?'Complete':'Pending' }}</span>
                </div>
            </div>
            <div class="row mb-7">
                <label class="col-lg-4 fw-semibold text-muted">
    ...
    <div class="card card-flush py-4 mb-10 card-mrs-issued-items">
        ...
        <div class="card-body pt-0">
            <x-elements.datatable id="material-issuance-item" class="table-striped table-sm align-middle table-row-dashed dataTable">
    ...
    <div class="card card-flush py-4 mb-10 card-issued-to">
        ...
        <div class="card-body pt-0">
            <x-elements.datatable id="material-issuance-received-by" class="table-striped table-sm align-middle table-row-dashed dataTable">
            </x-elements.datatable>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-header justify-content-center" id="">
                    <div class="text-center">
                        <h1 class="mb-3 modal-title">Material Issuance Details</h1>
                ...
                <div class="modal-body px-10">
                    <form id="form-material-issuance-details" modal-id="#modal-material-issuance-details" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="">
                        <div class="px-5">
                            <div class="row">
                                ...
                                <div class="d-flex flex-column col-6  fv-row mb-7 fv-plugins-icon-container">
                                    ...
                                    <input type="text" name="mrs_no" class="form-control mb-3 mb-lg-0" value="">
                                    <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                                </div>
                            </div>
                            ...
                            <div class="fv-row mb-7 fv-plugins-icon-container">
                                <x-elements.select
                                    ...
                                    name="status"
                                    label="Status"
                                    :options="['1' => 'Completed', '2' => 'Incomplete']"
                                    placeholder="Select an option"
                                    selected=""
                                    class="fw-bold form-select-solid"
                                    data-control="select2"
    ...
    <div class="modal fade" id="modal-mrs-available-items" tabindex="-1" aria-hidden="false" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-focus="false">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <x-elements.datatable id="mrs-available-items" class="table-striped table-sm align-middle table-row-dashed dataTable">
                    </x-elements.datatable>
                </div>
            </div>
        </div>
